...
/*    private static HttpClient sharedClient = new()
    ...
    {
        string accessKey = "tPGzF4DYGdNCWa7LtZuNCh";
        // YCAJESpTGU0vjkBz0cF4rN9DB
        string secretKey = "8238quTr9FNQRLYdUXGvbnYG29h3HnTmBW5GHDBrsjFx";
        // YCO5UVBdijjVvDHFJR_w4f64mXrWXp-7bee3tJS2
        AmazonS3Config config = new AmazonS3Config{ ServiceURL = "https://hb.ru-msk.vkcs.cloud" };
        // s3.yandexcloud.net
        public Form1()
        {
            InitializeComponent();
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            {
                var listobj = s3client.ListObjects(new ListObjectsRequest() { BucketName = "youtubebuck" });
                // youtubebacket
        ...
        private async void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //    https://functions.yandexcloud.net/d4ej6u7pukde3gcrhcho
                var request = new HttpRequestMessage(HttpMethod.Get, "https://functions.yandexcloud.net/d4eg42jnfettbt3asd34?integration=raw")
                {
...
/*            if (index != System.Windows.Forms.ListBox.NoMatches)
            ...
            using (var s3client = new AmazonS3Client(accessKey, secretKey, config))
            {
                ...
                {
                    BucketName = "youtubebuck",
                    Key = name
                };
                using (GetObjectResponse response = s3client.GetObject(objectRequest))
                {
                ...
                //channeldata = new HttpClient().GetStringAsync(obj).Result.Split(new string[] { "\r\n", "\r", "\n" }, StringSplitOptions.None));
            }
            // string urlitem = "https://youtubebuck.hb.ru-msk.vkcs.cloud/";
            // https://storage.yandexcloud.net/youtubebacket/
            //urlitem += name;
            lname.Visible = true;
            subs.Visible = true;
            lsubs.Visible = true;
